...
(defn linked-item
  ...
  [:li
   [:b {:style {:color vi/dark-blue :text-decoration "underline" :cursor "pointer" :margin "1em 0"}
...
(defn home-page
  ...
  [:div {:style {:max-width "50em"}}
   ...
   [:ul
    ...
    [:li [:b {:style {:color vi/dark-blue}} "COMING SOON - Weighted Observed:"] " brew-bot will utilize weights learned from scraping real world beer recipes by style."]]])
