(ns brew-bot.ingredient-lists.yeasts
  "Ingredient data for common commercial yeasts")

(def ^:const wyeast-yeasts
...
(def ^:const lallemand-lalvin-yeasts
