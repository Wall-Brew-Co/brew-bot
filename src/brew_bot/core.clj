...
(defn -main
  "Try me out!"
  [& args]
  (println (generate-beer-recipe :weighted-random 5 {:weight 5.0 :probabilities {:pale-malt-2-row-us 40 :pale-malt-2-row-uk 40 :caramel-crystal-malt-40l 20 :caramel-crystal-malt-60l 10 :chocolate-malt 2 :black-patent-malt 1}}
